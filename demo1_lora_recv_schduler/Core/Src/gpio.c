...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LORA_RESET_Pin|GPIO_PIN_15, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LORA_BUSY_Pin PB12 PB13 */
  GPIO_InitStruct.Pin = LORA_BUSY_Pin|GPIO_PIN_12|GPIO_PIN_13;
